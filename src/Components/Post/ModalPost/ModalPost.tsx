...
export const ModalPost = (props: ModalType) => {
    const settings = {
        infinite: false,
        dots: true,
    };
            ...
            {props.isOpen && (
                <div className="modal-overlay" onClick={props.toggle}>
                    <div onClick={(e) => e.stopPropagation()} className="modal-box">
                        <div className="post_content_modal">
                            <div className="closepopupicon" onClick={props.toggle}>
                                ...
                                <div className="slickwrapcontainer">
                                    <Slider {...settings}>
                                        {post.url.map((image: any, i: any) => (
                                            <div key={i}>
                                                <img className="post_image_img" src={image} alt="image_ post" />
                                            </div>
                                        ))}
                                    </Slider>
                                </div>
